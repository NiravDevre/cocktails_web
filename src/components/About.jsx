...
const About = () => {
    useGSAP(() => {
        ...
        .from('.top-grid div, .bottom-grid div', {
            opacity:0, duration: 1, ease: 'power1.in.out', stagger:0.04,
        }, '-=0.5')
    })
    return(
        <div id="about">
            <div className="mb-16 md:px-20 3xl:px-0 px-5">
                <div className="content">
                    ...
                    <div className="sub-content">
                        <p>
                         ...
                         drink intoo something truly memorable.
                        </p>
                        <div>
            ...
            <div className="top-grid md:px-20 3xl:px-0">
            ...
            <div className="bottom-grid md:px-20 3xl:px-0">
                <div className="md:col-span-8">
                    <div className="noisy">
