...
const Menu = () => {
    ...
    const getCocktailAt = (indeexOffSet) =>{
        return allCocktails[(currentIndex + indeexOffSet + totalCocktails) % totalCocktails]
    }
    ...
    return (
        <section id="menu" aria-label="menu-heading">
            ...
            <nav className="cocktail-tabs" aria-label="Cocktail Navigatiion">
